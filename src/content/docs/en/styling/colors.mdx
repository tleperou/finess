...
<Colors>
  ...
  The color surface uses the color `Canvas` of the [`<system-color>`](https://developer.mozilla.org/en-US/docs/Web/CSS/system-color#mark) when supported, or predefined values from a `p3` or `RGB` color space.

  {/* ### Customisation

  <details open>
    <summary class="sr-only"></summary>
    <ul role="list">
      <li>--color-surface<span><input type="text" /></span></li>
      <li>--color-surface-hex<span><ColorPicker color="--color-surface" /> <span data-color="--color-surface"></span></span></li>
      <li>--color-surface-contrast<span><ContrastPicker contrast="--color-surface-contrast" /> <span data-contrast="--color-surface-contrast"></span></span></li>
    </ul>
  </details>
